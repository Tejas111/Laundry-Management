    ...
    <body>
        ...
        <div class="container">
            ...
            <div id="block">
				...
				//    }
                  ?> -->
                  <button type="button" class="btn btn-default btn-lg" style="float:right; margin-top:20px; margin-right:20px;" onClick="window.location.href='./custindex.php'">OK</button>
                  <br><br><br><br>
                  <div id="printblock">
                  <h5>Cash Bill</h5>
                  <h3>LAUNDRY POINT</h3>
